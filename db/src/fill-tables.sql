...
insert into living_races(race_id, planet_id)
values ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Пихора')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Галон')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Галон')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Галон')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Галон')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Земец')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Земец')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Земец')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Земец')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Земец')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Стант')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Стант')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Шкоты')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Шкоты')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Шкоты')),
       ...
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Макам')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Чиамба')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Чиамба')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Чиамба')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Чиамба')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Ноноза')),
       ...
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Нельма')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Кекур')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Крунер')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Аптих')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Кайчи')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Дачка')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Дачка')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Дачка')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Дачка')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Накол')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Отроек')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Популо')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Флокен')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Флокен')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Флокен')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Абсент')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Голак')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Фильтр')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Вещун')),
       ...
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Эсбоит')),
       ...
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Воблер')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Палики')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Миссия')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Адденд')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Свара')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Свара')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Свара')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Свара')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Такель')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Такель')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Такель')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Такель')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Такель')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Филад')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Ввозка')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Сейаб')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Бирка')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Сутра')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Дутар')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Дутар')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Дутар')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Дутар')),
       ...
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Порте')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Лесище')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Стринг')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Стринг')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Сувари')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Осаги')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Вейка')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Фронт')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Коржец')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Тумыр')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Жатка')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Зубец')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Список')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Жилица')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Чаньго')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Чаньго')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Чаньго')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Чаньго')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Долбяк')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Долбяк')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Долбяк')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Долбяк')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Менса')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Облов')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Нафтид')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Ежиха')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Усмарь')),
       ...
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Комик')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Комик')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Комик')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Невод')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Невод')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Невод')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Невод')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Невод')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Форинт')),
       ...
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Форинт')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Форинт')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Котище')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Котище')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Напор')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Ларга')),
       ((select id from race where race.name = 'Малок'), (select id from planet where planet.name = 'Бинард')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Бинард')),
       ((select id from race where race.name = 'Пеленг'), (select id from planet where planet.name = 'Бинард')),
       ((select id from race where race.name = 'Гаалец'), (select id from planet where planet.name = 'Бинард')),
       ((select id from race where race.name = 'Фэяне'), (select id from planet where planet.name = 'Бинард')),
       ((select id from race where race.name = 'Человек'), (select id from planet where planet.name = 'Ворон')),
